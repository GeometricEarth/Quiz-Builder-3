...
function importMockImages(context) {
  context.keys().forEach((image, i) => (mockData[i].image = context(image)));
}
importMockImages(require.context("../assets/mockData/", false, /\.jpeg$/));
